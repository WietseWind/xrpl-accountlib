...
describe('XRP Native asset', function () {
  it('XRP as native to be native', function () {
    ...
    expect(sign(baseTxXrp, derive.familySeed(fixtures.familySeed.secp256k1.seed), definitions).signedTransaction.slice(24, 64)).toEqual(
  ...
  it('XAH as native to be native', function () {
    ...
    expect(sign(baseTxXah, derive.familySeed(fixtures.familySeed.secp256k1.seed), definitions).signedTransaction.slice(24, 64)).toEqual(
      '0000000000000000000000000000000000000000',
    )
  })
