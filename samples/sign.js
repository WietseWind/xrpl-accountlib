...
console.log('Sign: one account', lib.sign(Tx, lib.derive.familySeed('shqNUmrgnkBmK9iCijrtid2Ua4uHd')))
console.log()
...
console.dir(lib.sign(Tx, [
  lib.derive.familySeed('sp5mkm12oJj3t8fFRiaMNrDbc73N2'),
  lib.derive.familySeed('snYHBZDJ51PPSuzWYVhEh1kb9zvEU').signAs('rPEPPER7kfTD9w2To4CQk6UCfuHM9c6GDY')
]), { depth: null })
console.log()
